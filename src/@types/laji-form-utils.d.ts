...
declare module "laji-form/lib/utils" {
	namespace utils {
		function parseJSONPointer(object: any, jsonPointer: string, safeMode?: boolean | "createParents", strictEmptyPath?: boolean): any;
		...
		function updateSafelyWithJSONPointer(obj: any, value: any, path: string, immutably?: boolean, createNew?: (obj: any, split: string) => any): any
