...
const modalNmspc = nmspc("modal");
export const Modal = ({children, header, onClose}: {children: React.ReactNode, header?: React.ReactNode, onClose: () => void})  => {
	const modalStyle = {
		position: "fixed",
		top: "50%",
		left: "50%",
	...
	const modal = (
		<React.Fragment>
			...
			<div style={modalStyle} className={modalNmspc()}>
				<div>
					{header}
					<button
						style={{float: "right"}}
